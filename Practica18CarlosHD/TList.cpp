...
int TList::Push(const ITest * psz)
{
...
*/
const ITest * TList::Pop()
{
	ITest * firstElement = nullptr;
	if (listData->m_first)
	{
		firstElement = listData->m_first->m_content->Copy();
	...
	return const_cast<const ITest *>(firstElement);
}
/*********************/
